...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-plist', __webpack_require__(3));
  Vue.component('detail-plist', __webpack_require__(6));
  Vue.component('form-plist', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.urlComponent = this.$parent.$children.find(function (x) {
      return x.$props.field.attribute == "url";
    });
  ...
  methods: {
    ...
    handleIOSGODS: function handleIOSGODS() {
      var _this = this;
      ...
      Object.keys(_axios.defaults.headers.common).forEach(function (key) {
    ...
    handleTUTUBOX: function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios.get("/tutubox/cert");

              case 2:
                certName = _context.sent;
                plist = "https://tutubox.io/plists/" + certName.data + "/" + this.value + ".plist";
      ...
      function handleTUTUBOX() {
        return _ref.apply(this, arguments);
      }

      return handleTUTUBOX;
    }(),
