...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        GetKeys: function GetKeys() {
            ...
            Nova.request().get('/nova-vendor/ads/stripe/key').then(function (response) {
                _this.stripe_key = response.data;
                return Nova.request().get('/nova-vendor/ads/stripe/secret');
            }).then(function (response) {
                _this.stripe_secret = response.data;
                _this.getting_key = false;
                setTimeout(function () {
                    _this.SetupStripe();
                }, 1000);
            });
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                return _context.abrupt('return', Nova.error('Card holder field required'));

                            case 4:
                                this.stripe_loading = true;
                                _context.next = 7;
                                return this.stripe.handleCardSetup(this.stripe_secret, this.card_element, {
                                    payment_method_data: {
                                        billing_details: {
                            ...
                            case 7:
                                ...
                                return _context.abrupt('return', this.StripeError(error));

                            case 14:
                                return _context.abrupt('return', this.StripeSuccess(setupIntent));
        ...
        StripeSuccess: function StripeSuccess(data) {
            var _this2 = this;
            ...
            Nova.request().post('/nova-vendor/ads/stripe/payment_method', {
                ...
                _this2.stripe_loading = false;
            }).catch(this.StripeError);
        },
        StripeError: function StripeError(error) {
            ...
            [
              ...
              _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.card_holder,
                      expression: "card_holder"
                    }
                  ],
                  staticClass:
                  ...
                  domProps: { value: _vm.card_holder },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.card_holder = $event.target.value
                    }
                  }
                }),
                _vm._v(" "),
