...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module 'umbrellajs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'umbrellajs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(".scroll-toggler").on('click', function () {
  console.log("toggle scroll");

  if (Object(scroll_lock__WEBPACK_IMPORTED_MODULE_3__["getScrollState"])()) {
    Object(scroll_lock__WEBPACK_IMPORTED_MODULE_3__["disablePageScroll"])();
  } else {
