...
<div class="mx-auto w-full text-center mt-12 px-3" style="max-width: 700px">
    ...
    <div class="my-10">
        ...
        @else
            <a href="/install?theme=light" class='hide-webapp mx-1 mb-16 flex items-center justify-center font-bold rounded-full text-sm px-8 py-5 text-black-light bg-yellow-500'>
