...
@php
    $title = "Privacy Policy | iOS Haven";
@endphp
...
@section('content')
    <article class="max-w-prose mx-auto">
        <section class="markdown mx-auto mt-8">
            <h1>Privacy Policy for iOS Haven</h1>

            <p>At iOS Haven, accessible from ioshaven.com, one of our main priorities is the privacy of our visitors.
                This Privacy Policy document contains types of information that is collected and recorded by iOS Haven
                and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in iOS Haven. This policy is not applicable
            ...
            <p>iOS Haven follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, iOS Haven uses 'cookies'. These cookies are used to store information including
            ...
            <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve
                ...
                network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a>
            </p>
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of iOS
                Haven.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on iOS Haven, which are sent directly to
            ...
            <p>Note that iOS Haven has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>iOS Haven's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>iOS Haven does not knowingly collect any Personal Identifiable Information from children under the age of
