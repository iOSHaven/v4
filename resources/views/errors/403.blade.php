...
<div class="mx-auto w-full text-center mt-12 px-3" style="max-width: 700px">
    ...
    <div class="markdown mt-4 w-96 mx-auto">
        <p>This page appears to locked or inaccessible.  Are you sure the URL is correct?  We would greatly appreciate your assistance on reporting this error.</p>
    </div>

    <x-twitter-button class="w-40 mx-auto py-2 mt-3" text="report" :message='"Hello @ioshavencom, this URL has a 403 error: \n\n" . url()->current()'/>
</div>
@endsection